...
let sum = a + b + c;
console.log(sum);
let str: string = `the value of sum is: ${sum}.`;
console.log(str);
...
function aFunction() {
    ...
    console.log(e);
    //console.log(f); not allowed because f is of type let
}
//console.log(e); not allowed because e only lives inside the function
